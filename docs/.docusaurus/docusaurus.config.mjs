...
export default {
  ...
  "projectName": "cosmic-crypto-tracker",
  "onBrokenLinks": "throw",
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/your-github-org/cosmic-crypto-tracker/tree/main/docs/"
        },
        "blog": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Cosmic Crypto Tracker. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
